                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-6 ">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control" type="number" step="any" name="registration_bonus" required
                                            value="{{ getAmount(gs('registration_bonus')) }}">
                            ...
                            <div class="form-group col-sm-6 ">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="default_plan">
                                        <option value="">@lang('Select One')</option>
                                        <option value="0">@lang('None')</option>
                                        @foreach ($plans as $plan)
                                            <option value="{{ $plan->id }}" @if (@gs('default_plan') == @$plan->id) selected @endif>{{ __($plan->name) }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="form-group col-sm-6 ">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control" type="number" step="any" name="bt_fixed" required
                                            value="{{ getAmount(gs('bt_fixed')) }}">
                                        <span class="input-group-text">{{ __(gs('cur_text')) }}</span>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group col-sm-6 ">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control" type="number" step="any" name="bt_percent" required
                                            value="{{ getAmount(gs('bt_percent')) }}">
