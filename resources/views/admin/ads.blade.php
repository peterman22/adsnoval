...
<div class="grid grid-2" style="align-items:start">
  <div class="card">
    ...
    <form method="POST" action="{{ route('admin.ads.store') }}" enctype="multipart/form-data">@csrf
    ...
    @forelse($ads as $a)
      <details style="border-bottom:1px solid var(--border);padding:10px 0">
        ...
        <form method="POST" action="{{ route('admin.ads.update',$a) }}" enctype="multipart/form-data" style="margin-top:10px">@csrf
          ...
          <div class="field"><label class="label">Replace with uploaded video (optional)</label><input class="input" type="file" name="video" accept="video/mp4,video/webm,video/ogg"></div>
