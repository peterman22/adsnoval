            ...
            <form>
                <div class="d-flex flex-wrap gap-4">
                    ...
                    <div class="flex-grow-1">
                        ...
                        <select name="trx_type" class="from-control form--control select2" data-minimum-results-for-search="-1">
                    ...
                    <div class="flex-grow-1">
                        ...
                        <select class="from-control form--control select2" name="remark" data-minimum-results-for-search="-1">
