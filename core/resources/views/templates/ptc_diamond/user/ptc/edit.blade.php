                ...
                <div class="row">
                    ...
                    @if ($ptc->ads_type == 1)
                        <div class="form-group col-md-8">
                            ...
                            <input type="text" name="website_link" class="form-control form--control" value="{{ $ptc->ads_body }}"
                            ...
                            @foreach ($ptc->schedule as $key => $schedule)
                                <div class="form-group">
                                    <div class="row gy-4">
                                        ...
                                        <div class="col-md-3">
                                            <input type="time" name="schedule[{{ $key }}][start]" class="form-control form--control"
                                                value="{{ $schedule['start'] }}" required>
                                        </div>
                                        <div class="col-md-3">
                                            <input type="time" name="schedule[{{ $key }}][end]" class="form-control form--control"
                                                value="{{ $schedule['end'] }}" required>
                                        </div>
                                        <div class="col-md-2">
                                            <button type="button" class="btn btn--danger btn--lg w-100 scheduleClose"><i
